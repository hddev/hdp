...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
            ...
            <xsl:apply-templates select="/RCMAccessList"/>
    </xsl:template>
    
    <xsl:template match="RCMAccessList">
    	
    	<div id="popupContact">
    		<a id="popupContactClose">x</a>
			<h1>Выбор типа</h1>
			<b>Укажите для кого следует добавить курс:</b><br/><br/>
			<table>
				<tr>
					<td>
						<select size="1" id="access_id_type" name="access_id_type">
		                    <option value="0">для группы</option>
							<option value="1">для студента</option>
						</select>
	               </td>
	            </tr>
	        </table>
			...
			<div id="buttons" style="float:right;">
				<ul class='nNav btnList'>
		          <li>
			           ...
			           <span class="ncc"><a onclick="disablePopup(); document.location.href='/admin/?action=rcm-access-edit&amp;access_id=0&amp;access_id_type='+document.getElementById('access_id_type').value" href="javascript:void();"> Добавить </a></span>
			           <b class="nc"><b class="nc2"><b></b></b><b class="nc1"><b></b></b></b>
			      </li>
			      <li>&#160;</li>
		          <li>
			           <b class="nc"><b class="nc1"><b></b></b><b class="nc2"><b></b></b></b>
			           <span class="ncc"><a id="CloseModal"> Отменить </a></span>
			           <b class="nc"><b class="nc2"><b></b></b><b class="nc1"><b></b></b></b>
			      </li>
			    </ul>
		    </div>
    	...
    	<table cellspacing="0" cellpadding="0" border="0">
    		...
    		<xsl:apply-templates select="RCMAccessRow"/>
    		<tr>
    			<td class="first"></td>
    			<td colspan="5" align="right">
    			
    			<div id="button"><a><img src="/images/iicons/add.png" alt="Добавить" title="Добавить"/></a>&#160;
                <a href="/admin/admin-ajax/?action=rcm-material-delete&amp;id={@id}" class="remote-url"><img src="/images/iicons/cross.png" alt="" title=""/></a></div>
    	...
    	<input type="hidden" name="action" value="rcm-access-list" />
    	<!--<input type="hidden" name="page" value="{//Pagination/@page}" />-->
    	</form>
    	</div>
    </xsl:template>
    
    <xsl:template match="RCMAccessRow">
    	<tr>
    		...
    		<xsl:if test="@access_id_type = 0">
    			<xsl:value-of disable-output-escaping = "yes" select = "@group_title" />
    		</xsl:if>
    		...
    		<td>
    			<a href='/admin/?action=rcm-access-edit&amp;access_id={@id}'><img src='/images/iicons/layout_edit.png'  alt='Редактировать.' title='Редактировать.'/></a>
				<a href='/admin/?action=rcm-access-delete&amp;access_id={@id}'><img src='/images/iicons/layout_delete.png' alt='Удалить' title='Удалить'/></a>
    		</td>
    		<td class="last"></td>
    	</tr>
    </xsl:template>
    ...
    <xsl:template match="Pagination">
    	...
    	<tr>
    		<td class="first"></td>
    		<td colspan="5" align="right">
    			<div class="pagination"><a href="/admin/?action=rcm-access_list&amp;page=0" id="page_prev_start" style="text-decoration: none;">&lt;&lt;</a></div>
    			<xsl:if test="@page &gt; 0">
    				<div class="pagination"><a href="/admin/?action=rcm-access_list&amp;page={$prev_page}" id="page_prev" style="text-decoration: none;">&lt;</a></div>
    			</xsl:if>
    			...
    			<xsl:if test="@page &lt; @total_pages">
    				<div class="pagination"><a href="/admin/?action=rcm-access_list&amp;page={$next_page}" id="page_next" style="text-decoration: none;">&gt;</a></div>
    			</xsl:if>
    			<div class="pagination"><a href="/admin/?action=rcm-access_list&amp;page={@total_pages}" id="page_next_end" style="text-decoration: none;">&gt;&gt;</a></div>
    ...
    <xsl:template name="page">
    	...
    	<xsl:if test="$i = 0 or $i = $max or ($i &gt; $first_visible and $i &lt; $last_visible)">
    		<div class="pagination"><xsl:if test="$i = $current"><xsl:attribute name="style">background-color: #ccd74f;</xsl:attribute></xsl:if><a href="/admin/admin-ajax/?action=test-questionlist&amp;page={$i}" id="page{$i}" class="remote-post">
