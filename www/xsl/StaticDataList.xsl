...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
            <xsl:apply-templates select="/StaticDataList"/>
    </xsl:template>
    
    <xsl:template match="StaticDataList">
    ...
    <xsl:template match="StaticData">
    	<tr>
    		...
    		<td><xsl:value-of disable-output-escaping = "yes" select = "@group_id" /></td>
    		<td>
    			<a href="/admin/admin-ajax/?action=static-data-form&amp;id={@id}" class="remote-url"><img src="/images/iicons/layout_edit.png" alt="Редактировать статический элемент." title="Редактировать статический элемент."/></a>&#160;
    			<a href="#"><img src="/images/iicons/layout_delete.png" alt="Удалить статический элемент." title="Удалить статический элемент."/></a>
    		</td>
    		<td class="last"></td>
    	</tr>
    </xsl:template>
    ...
    <xsl:template match="Pagination">
    	...
    	<tr>
    		<td class="first"></td>
    		<td colspan="5" align="right">
    			<div class="pagination"><a href="/admin/admin-ajax/?action=xsltemplates-list&amp;page=0" id="page_prev_start" class="remote-post" style="text-decoration: none;">&lt;&lt;</a></div>
    			<xsl:if test="@page &gt; 0">
    				<div class="pagination"><a href="/admin/admin-ajax/?action=xsltemplates-list&amp;page={$prev_page}" id="page_prev" class="remote-post" style="text-decoration: none;">&lt;</a></div>
    			</xsl:if>
    			...
    			<xsl:if test="@page &lt; @total_pages">
    				<div class="pagination"><a href="/admin/admin-ajax/?action=xsltemplates-list&amp;page={$next_page}" id="page_next" class="remote-post" style="text-decoration: none;">&gt;</a></div>
    			</xsl:if>
    			<div class="pagination"><a href="/admin/admin-ajax/?action=xsltemplates-list&amp;page={@total_pages}" id="page_next_end" class="remote-post" style="text-decoration: none;">&gt;&gt;</a></div>
