...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="Users">
    	...
    	<table cellspacing="0" cellpadding="0" border="0">
    		<thead>
    			...
    			<th>
    				<img src="/images/iicons/database_lightning.png" alt="Подключен" title="Пользователь подключен"/>&#160;
    			</th>
				<th>
    				Логин&#160;
    ...
    <xsl:template match="User">
    	...
    	<tr>
			...
			<td><xsl:if test="@connected = '1'"><img src="/images/iicons/database_lightning.png" alt="Подключен" title="Пользователь подключен"/></xsl:if></td>
    ...
    <xsl:template match="Pagination">
    	...
    	<tr>
    		<td class="first"></td>
    		<td colspan="6" align="right">
    			<div class="pagination"><a href="/admin/admin-ajax/?action=users-list&amp;page=0" id="page_prev_start" class="remote-post" style="text-decoration: none;">&lt;&lt;</a></div>
    			<xsl:if test="@page &gt; 0">
    				<div class="pagination"><a href="/admin/admin-ajax/?action=users-list&amp;page={$prev_page}" id="page_prev" class="remote-post" style="text-decoration: none;">&lt;</a></div>
    			</xsl:if>
    			...
    			<xsl:if test="@page &lt; @total_pages">
    				<div class="pagination"><a href="/admin/admin-ajax/?action=users-list&amp;page={$next_page}" id="page_next" class="remote-post" style="text-decoration: none;">&gt;</a></div>
    			</xsl:if>
    			<div class="pagination"><a href="/admin/admin-ajax/?action=users-list&amp;page={@total_pages}" id="page_next_end" class="remote-post" style="text-decoration: none;">&gt;&gt;</a></div>
