   ...
   <xsl:template match="Departments">
    	...
    	<table cellspacing="0" cellpadding="0" border="0">
    		...
    		<tr>
    			...
    			<!-- <a href="/admin/admin-ajax/?action=department-form&amp;id=0" class="remote-url"><img src="/images/iicons/add.png" alt="Создать новое подразделение" title="Создать новое подразделенеи"/></a>&#160;
                <a href="/admin/admin-ajax/?action=department-delete&amp;id={@id}" class="remote-url"><img src="/images/iicons/cross.png" alt="Удалить подразделение" title="Удалить подразделение"/></a>  -->
    			</td>
    			<td class="last"></td>
    		</tr>
    		<tr>
    	...
    	<input type="hidden" name="action" value="departments-list" />
    ...
    <xsl:template match="Pagination">
    	...
    	<tr>
    		<td class="first"></td>
    		<td colspan="5" align="right">
    			<div class="pagination"><a href="/admin/admin-ajax/?action=departments-list&amp;page=0" id="page_prev_start" class="remote-post" style="text-decoration: none;">&lt;&lt;</a></div>
    			<xsl:if test="@page &gt; 0">
    				<div class="pagination"><a href="/admin/admin-ajax/?action=departments-list&amp;page={$prev_page}" id="page_prev" class="remote-post" style="text-decoration: none;">&lt;</a></div>
    			</xsl:if>
    			...
    			<xsl:if test="@page &lt; @total_pages">
    				<div class="pagination"><a href="/admin/admin-ajax/?action=departments-list&amp;page={$next_page}" id="page_next" class="remote-post" style="text-decoration: none;">&gt;</a></div>
    			</xsl:if>
    			<div class="pagination"><a href="/admin/admin-ajax/?action=departments-list&amp;page={@total_pages}" id="page_next_end" class="remote-post" style="text-decoration: none;">&gt;&gt;</a></div>
