...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="Requests">
    	...
    	<form name="requestdata" id="ajaxform" action="." method="POST">
    	<table cellspacing="0" cellpadding="0" border="0">
    		...
    		<tr>
    			...
    			<a href="/requests-ajax/?action=request-form&amp;id=0" class="remote-url"><img src="/images/iicons/add.png" alt="Создать новый запрос" title="Создать новый запрос"/></a>&#160;
                <a href="/requests-ajax/?action=request-delete&amp;id={@id}" class="remote-url"><img src="/images/iicons/cross.png" alt="Удалить запрос" title="Удалить запрос"/></a>
    			</td>
    			<td class="last"></td>
    		</tr>
    		<tr>
    			<td class="first"></td>
    			<td colspan="7" class="table-seporater"></td>
    			<td class="last"></td>
    		</tr>
    		<xsl:apply-templates select="Pagination"/> 
    		<tr>
    			<td class="bfirst"></td>
    			<td colspan="7" class="bbottom"></td>
    			<td class="blast"></td>
    		</tr>
    	</table>
    ...
    <xsl:template match="Request">
    	...
    	<tr>
			...
			<td><xsl:value-of disable-output-escaping = "yes" select = "@request_number" /></td>
			<td><xsl:value-of disable-output-escaping = "yes" select = "@contractor_id" /></td>
    		<td><xsl:value-of disable-output-escaping = "yes" select = "@requesttext" /></td>
    		<td><xsl:value-of disable-output-escaping = "yes" select = "@fio" /></td>
    		<td><xsl:value-of disable-output-escaping = "yes" select = "@author_id" /></td>
    		<td>
    			<a href="/requests-ajax/?action=request-form&amp;id={@id}" class="remote-url"><img src="/images/iicons/layout_edit.png" alt="Редактировать запрос." title="Редактировать запрос."/></a>&#160;
    			<a href="/requests-ajax/?action=request-delete&amp;id={@id}" class="remote-url"><img src="/images/iicons/layout_delete.png" alt="Удалить запрос." title="Удалить запрос."/></a>
    		</td>
    		<td class="last"></td>
    	</tr>
    </xsl:template>
    ...
    <xsl:template match="Pagination">
    	...
    	<tr>
    		...
    		<td colspan="6" align="right">
    			<div class="pagination"><a href="/requests/?action=users-list&amp;page=0" id="page_prev_start" class="remote-post" style="text-decoration: none;">&lt;&lt;</a></div>
    			<xsl:if test="@page &gt; 0">
    				<div class="pagination"><a href="/requests/?action=users-list&amp;page={$prev_page}" id="page_prev" class="remote-post" style="text-decoration: none;">&lt;</a></div>
    			</xsl:if>
    			...
    			<xsl:if test="@page &lt; @total_pages">
    				<div class="pagination"><a href="/requests/?action=users-list&amp;page={$next_page}" id="page_next" class="remote-post" style="text-decoration: none;">&gt;</a></div>
    			</xsl:if>
    			<div class="pagination"><a href="/requests/?action=users-list&amp;page={@total_pages}" id="page_next_end" class="remote-post" style="text-decoration: none;">&gt;&gt;</a></div>
