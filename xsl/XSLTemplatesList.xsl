...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="XSLTemplate">
    	...
    	<tr>
    		...
    		<td>
    			<xsl:if test = "@file_exists = 0">
    				<a href="/admin/admin-ajax/?action=xsltemplate-form&amp;id={@id}" class="remote-url"><img src="/images/iicons/layout_edit.png" alt="Редактировать XSL шаблон." title="Редактировать XSL шаблон."/></a>&#160;	
    				<img src="/images/iicons/layout_error.png" alt="Файл XSL шаблона отсутствует." title="Файл XSL шаблона отсутствует." />
    			</xsl:if>
    			<xsl:if test = "@file_exists = 1">
    				<a href="/admin/admin-ajax/?action=xsltemplate-form&amp;id={@id}" class="remote-url"><img src="/images/iicons/layout_edit.png" alt="Редактировать XSL шаблон." title="Редактировать XSL шаблон."/></a>&#160;
